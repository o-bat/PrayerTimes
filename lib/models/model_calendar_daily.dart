...
//
//     final calendarDaily = calendarDailyFromJson(jsonString);

import 'dart:convert';

CalendarDaily calendarDailyFromJson(String str) =>
    CalendarDaily.fromJson(json.decode(str));

String calendarDailyToJson(CalendarDaily data) => json.encode(data.toJson());
...
class CalendarDaily {
  ...
  factory CalendarDaily.fromJson(Map<String, dynamic> json) => CalendarDaily(
        code: json["code"],
        status: json["status"],
